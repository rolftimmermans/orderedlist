module OrderedList
  module ActiveRecord
    module Orderable
      ...
      included do
        # Returns a scope on which list operations can be executed.
        scope :list_base do
        ...
        class << self
          delegate :ordered, :reversed, to: :list_base
        end
      end
      ...
      def list
        list_scope_columns.inject(self.class.list_base) do |relation, column|
